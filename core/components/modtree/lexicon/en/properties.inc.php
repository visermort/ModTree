...
$_lang['modtree_prop_limit'] = 'The number of Items to limit per page.';
$_lang['modtree_prop_outputSeparator'] = 'A string to separate each row with.';
$_lang['modtree_prop_sortBy'] = 'The field to sort by.';
