<div class="mod-tree container clearfix">
    ...
    <div class="mod-tree__tree ">
        <div class="mod-tree__seach"
             data-url="[[++modtree_assets_urs]]connector.php"
             data-limit="[[+searchLimit]]"
             data-linkway="[[+linkWay]]"
             data-sortby="[[+sortBy]]"
             data-sortdir="[[+sortDir]]">

            [[+searchfields:ne=``:then=`<ul class="mod-tree__seach-fields">[[+searchfields]]</ul>
            <button id="mod-tree_seach-button" class="mod-tree_seach-button button" >[[+button-label]]</button>`]]
        </div>
        [[+items:ne=``:then=`
